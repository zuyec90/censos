...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 05-10-2015 a las 07:19:14
...
(11, 'Gleiver', 'Gil', 'v', 18761800, '1990-01-07', 25, '', 'si', '2 aÃ±o', 'no', '', 'no', '', 0, 3154388, 0, 2422175, 0, 8807196, 'giegm_0507@hotmail.com', 'soltero (a', 'Bachiller', 1, 'Estudiante', 'no', '', 7000, '2015-09-29 15:40:00'),
...
(18, 'Edelis Carolay', 'Simons Escalona', 'v', 6438133, '1943-03-19', 12, 'f', 'no', '2 aÃ±o', 'no', '', 'no', '', 0, 2161517, 0, 8807106, 0, 8807106, '', 'Casado (a)', 'Sin InstrucciÃ³n', 0, 'estudiante', 'no', 'Semanal', 10000, '2015-10-01 14:04:51'),
...
INSERT INTO `usuario` (`id_user`, `nombre`, `apellido`, `cedula`, `email`, `celular`, `sexo`, `voceria`, `perfil`, `usuario`, `contrasenia`, `status`, `fecha_creado`) VALUES
...
(3, 'ddq', 'dded1sdasd', 231231231, 'zuyecci@gmail.com1', 2147483647, 'm', 'usuario11', 1, 'fcg1sd', 'fgf1', 1, '2015-05-29'),
...
(12, 'Juan', 'Perez', 12344567, 'dsdffddsf@hff.com', 1234567, 'f', 'Unidad Ejecutiva', 2, 'juanito', '12345', 0, '2015-10-05');
