...
class censo extends DataModel
{
	...
	public function ModificarJefeflia($datos = Null)
	{
		...
		if (!empty($datos['idjefe_familia'])) {
			$sql = "UPDATE `jefeflia` SET `direccion` = '".$datos['direccion']."', `nombres` = '".$datos['nombres']."', `apellidos` = '".$datos['apellidos']."', `nacionalidad` = '".$datos['nacionalidad']."',`cedula` = '".$datos['cedula']."', `fecha_nacimiento` = '".$datos['fecha_nacimiento']."' , `edad` = ".$datos['edad'].", `sexo` = '".$datos['sexo']."', `cne` = '".$datos['cne']."', `tiempo_comunidad` = '".$datos['tiempo_comunidad']."', `incapacitado` = '".$datos['incapacitado']."', `tipo_incapacitado` = '".$datos['tipo_incapacitado']."', `pensionado` ='".$datos['pensionado']."', `institucion` = '".$datos['institucion']."', `codigo_cel` = '".$datos['codigo_cel']."', `telfcel` = '".$datos['telfcel']."', `codigo_hab` = '".$datos['codigo_hab']."', `telfhab` = '".$datos['telfhab']."', `codigo_ofic` = '".$datos['codigo_ofic']."', `telfofic` = '".$datos['telfofic']."', `email` = '".$datos['email']."', `estado_civil` = '".$datos['estado_civil']."', `nivel_instruccion` = '".$datos['nivel_instruccion']."', `profesion` ='".$datos['profesion']."', `trabaja` = '".$datos['trabaja']."', `clasificacion_ingreso_familiar` = '".$datos['clasificacion_ingreso_familiar']."', `ingreso_mensual` = '".$datos['ingreso_mensual'] ."' WHERE `idjefe_familia` = '".$datos['idjefe_familia'] ."'";
